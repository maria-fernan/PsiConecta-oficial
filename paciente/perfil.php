...
$sql = "SELECT nome, dtNasc, email, foto, telefone FROM paciente WHERE idPaciente = $idPaciente";
...
//$sqlTel = "SELECT telefone FROM telpaci WHERE idPaciente = $idPaciente";
//$telefoneRes = $conexao->query($sqlTel);

//if (!$telefoneRes) {
//    die("Erro na consulta SQL (telpaci): " . $conexao->error);
//}
    ...
    <div class="container text-center" style="margin-top: 50px;">
        <div class="row">
            ...
            <div class="col-4 col-md-4">
                ...
                <?php else: ?>
                    <svg id="previewFoto" style="color: #24609b; cursor:pointer;" xmlns="http://www.w3.org/2000/svg" 
            ...
            <div class="col-4 col-md-4">
                ...
                <div class="collapse" id="collapseExample">
                    <div class="card card-body">
                       <form id="formulario" class="formulario w-100" method="POST" action="editarPerfil.php" enctype="multipart/form-data">
                            <div class="campo">
            ...
            <div class="col-md-4 offset-md-4">
                <a href="../geral/pagPrincipal.html" class="btn" style="color:#183e64;">
